...
If you use mindmaps to capture and manage knowledge, but others working with you find them quite cumbersome to read and understand, then fp-convert is for you. It converts a freeplane mindmap to print-quality PDF documents. At present it converts a mindmap to a project specifications document. The same template can be used to build any knowledgebase and print it out as a beautiful PDF document. It uses LaTeX/pdflatex text processing system to create the PDF file.
