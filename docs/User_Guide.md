...
![Bullet list generation in the mindmap](images/unordered_list_mm.png)
...
![Bullet list in the document](images/unordered_list_pdf.png)

## Ordered Lists

![Numbered list generation in the mindmap](images/ordered_list_mm.png)
...
![Numbered list in the document](images/ordered_list_pdf.png)
...
![Code blocks in the mindmap](images/verbatim_mm.png)
